...
- Click the [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/geekup-legodevops/appsmith/tree/feature/heroku-with-netdata) button
